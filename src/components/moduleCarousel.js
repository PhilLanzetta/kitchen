...
const ModuleCarousel = ({ data }) => {
  ...
  const handleClick = () => {
    if (width > 700 && mousePos > width / 2 + 32) {
      sliderRef.current.slickNext()
    } else if (width > 700 && mousePos < width / 2 + 32) {
  ...
  return (
    ...
    >
      ...
      {hover && width > 700 && mousePos < width / 2 + 32 && (
        <div className={styles.cursor} style={position}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 191.309 119.567">
            <path
              id="Path_22"
              dataname="Path 22"
      ...
      {hover && width > 700 && mousePos > width / 2 + 32 && (
        <div className={styles.cursor} style={position}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 191.309 119.568">
            <path
              id="Path_14"
              data-name="Path 14"
